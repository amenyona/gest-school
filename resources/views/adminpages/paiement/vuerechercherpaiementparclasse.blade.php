        ...
        <div class="card">
            <div class="card-body">
                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light" style="background-color: #FFC107; border:none; font-size: 16px;"><em><h4>Rechercher les paiements par année académique pour les classes</h4></em></button>
                </div> <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2 dynamic" name="anneeacademiqueId"> 
