            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tr>
                        ...
                        <td>{{$item->impresssionComposition}}</td>
                        <td>{{retreiveAnnee($item->anneeacademique_id)}}</td>
                        <td>
                            <a href="{{route('composition.editInfoComposition',$item->uuid)}}" class="btn btn-success waves-light waves-effect"><i class="mdi mdi-pencil"></i></a>
                            <a href="{{route('composition.rechercherNotesComposPourModif',$item->uuid)}}" class="btn btn-primary waves-effect waves-light btn-sm">Appliquer Sanction <i class="mdi mdi-arrow-right ms-1"></i></a>
                        </td>
                    </tr>
                    @endForeach
