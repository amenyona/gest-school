        ...
        <div class="card">
            <div class="card-body">
                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light" style="background-color: #FFC107; border:none; font-size: 16px;"><em><h4> Page de création des scolarités</h4></em></button>
                </div> <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="scolarite" placeholder="Entrer la scolarite" value="{{old('scolarite')}}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                <label for="typematiere">Années Académiques</label>
