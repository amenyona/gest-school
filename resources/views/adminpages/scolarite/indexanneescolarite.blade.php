        ...
        <div class="card">
            <div class="card-body">
                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-secondary btn-sm waves-effect waves-light" style="background-color: #FFC107; border:none; font-size: 16px;"><em><h4> Liste des scolarités de l'années académique {{retreiveAnnee($annee['id'])}}</h4></em></button>
                </div> <br>
                <div class="mt-4">
