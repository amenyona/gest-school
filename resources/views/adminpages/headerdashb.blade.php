...
<html lang="en">
 ...
 <link href="{{asset('assets/libs/select2/css/select2.min.css')}}" rel="stylesheet" type="text/css" />
     ...
     <style>
      /* Bouton pour ceux qui ont fini de payer */
.btn-fini {
...
/* Bouton pour ceux qui n'ont pas fini de payer */
.btn-non-fini {
    background-color: #DC3545; /* Rouge attention */
    color: #FFFFFF; /* Texte blanc pour contraste */
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="assets/images/users/avatar-1.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1" key="t-henry">{{$user->name}} {{$user->firstname}}</span>
